...
The [Robotic Ultrasound workflow](https://github.com/isaac-for-healthcare/i4h-workflows/tree/main/workflows/robotic_ultrasound/README.md) provides an example of robotic teleoperation in an Isaac Lab simulation.
Teleoperation serves as an alternative to manually defined [state machine](https://github.com/isaac-for-healthcare/i4h-workflows/tree/main/workflows/robotic_ultrasound/scripts/simulation/environments/state_machine/)
...
Please review the [Robotic Ultrasound workflow setup instructions](https://github.com/isaac-for-healthcare/i4h-workflows/tree/main/workflows/robotic_ultrasound/README.md) for minimum system requirements.
...
Please follow the [Robotic Ultrasound workflow setup instructions](https://github.com/isaac-for-healthcare/i4h-workflows/tree/main/workflows/robotic_ultrasound/README.md) to install dependencies, download assets, and set environment variables.
...
1. Create a folder for OpenXR data with your user permissions:
...
1. Open required firewall ports for CloudXR OpenXR connections:
...
1. In a new terminal, run the CloudXR Runtime container with the mounted data folder:
...
1. Back in your Robotic Ultrasound workflow terminal, define the following environment variables:
...
Please verify that `PYTHONPATH` is set as specified in the `robotic_ultrasound` [README](https://github.com/isaac-for-healthcare/i4h-workflows/tree/main/workflows/robotic_ultrasound/README.md#environment-variables).
