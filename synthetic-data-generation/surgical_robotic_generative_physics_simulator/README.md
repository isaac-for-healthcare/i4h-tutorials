...
The surgical robotic synthetic data pipeline flows from teleoperation through world-model rollout, recording, and style augmentation:
...
```bash
gh repo clone isaac-for-healthcare/i4h-tutorials
cd i4h-tutorials/synthetic-data-generation/surgical_robotic_generative_physics_simulator
```
...
| ------------- | ---------------- | ----------- |
| [Needle pickup (video)](resources/suturebot_needle_pickup.mp4) | [Needle insertion (video)](resources/suturebot_needle_throw.mp4) | [Knot tying (video)](resources/suturebot_knot_tying.mp4) |
