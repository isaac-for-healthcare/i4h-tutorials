...
def get_frames_by_timestamps(
    ...
    if video_backend == "decord":
        ...
        # Note: closest key frame timestamp is usually smaller than `first_ts`
...
def get_all_frames_and_timestamps(
    ...
    if video_backend == "decord":
        ...
        raise NotImplementedError(f"Video backend {video_backend} not implemented for get_all_frames_and_timestamps")
