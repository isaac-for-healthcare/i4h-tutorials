...
class So100DataConfig(BaseDataConfig):
    ...
    state_keys = [
        "state.main_shoulder_pan",
        "state.main_shoulder_lift",
        "state.main_elbow_flex",
        "state.main_wrist_flex",
        "state.main_wrist_roll",
        "state.main_gripper",
    ]
    action_keys = [
        "action.main_shoulder_pan",
        "action.main_shoulder_lift",
        "action.main_elbow_flex",
        "action.main_wrist_flex",
        "action.main_wrist_roll",
        "action.main_gripper",
    ]
